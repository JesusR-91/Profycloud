const classes = [
    {name: 1,subName: "A", Subject: ["Matemáticas", "Física", "Programación", "Tecnología"]},
    {name: 1,subName: "B", Subject: ["Matemáticas", "Física", "Programación", "Tecnología"]},
...
const alumns =[
    {firstName: "Juan", lastName: "Bolsón", class: []},
    {firstName: "Pedro", lastName: "Skywalker", class: []},
    {firstName: "Jorge", lastName: "Vader", class: []},
    {firstName: "Jesús", lastName: "González", class: []},
    {firstName: "Jonathan", lastName: "Benítez", class: []},
    {firstName: "Maisha", lastName: "Ramírez", class: []},
    {firstName: "Jorge", lastName: "Ruiz", class: []},
    {firstName: "Carol", lastName: "Pérez", class: []},
    {firstName: "Jorge", lastName: "González", class: []},
